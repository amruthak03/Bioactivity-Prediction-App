...
with st.sidebar.header('1. Upload your CSV data'):
    ...
    st.sidebar.markdown("""
[Example input file](/Users/amrutha/Documents/bu_notes/projects/computational drug discovery/example_acetylcholinesterase.txt)
""")
...
if st.sidebar.button('Predict'):
    ...
    st.header('**After Removing low variance descriptors**')
